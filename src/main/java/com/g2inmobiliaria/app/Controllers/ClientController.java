...
public class ClientController {
    ...
    public ResponseEntity<?> registrarCliente(@RequestBody Map<String, Object> clienteData){
        ...
        cliente.getIdUser().getIdPerson().setSecondSurname((String) clienteData.get("SecondSurname")); // corregir "seconSurname" a "SecondSurname"
        ...
        int idRole = Integer.parseInt((String) clienteData.get("IdRole"));
        System.out.println((String) clienteData.get("IdRole"));

        return ResponseEntity.ok().body(clientService.registrarClient(cliente, telefono, email, idRole));
    }
