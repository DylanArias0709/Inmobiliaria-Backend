function desplegarFormPaymentMethod() {
    ...
    botones.forEach(function (boton) {
        boton.addEventListener('click', function () {
            ...
            xmlhttp.open("GET", "/payment-methods/paymentMethodForm?id=" + idPaymentMethod, true);
            xmlhttp.send();
                ...
                fetch(editarForm.action, {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            setTimeout(function () {
                                window.location.href = "/payment-methods/listarPaymentMethods";
                            }, 1000);
                        } else {
                    ...
                    fetch(crearForm.action, {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                setTimeout(function () {
                                    window.location.href = './listarPaymentMethods';
